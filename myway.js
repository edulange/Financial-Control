...
/*
pq não da isso? 
const deleteButton = document.querySelector('[data-button]')
console.log(deleteButton) isso retorna = null
pq eu criei a propriedade da classe pelo JS, não pelo html
*/
...
const transactionAction = (id, name, amount) => {
	//return dummyTransactions.push({ id: id, name: name, amount: amount });
	return dummyTransactions.push({ id, name, amount}); // É A MESMA COISA QUE EM CIMA, mas por causa do ES6, thx god
};
